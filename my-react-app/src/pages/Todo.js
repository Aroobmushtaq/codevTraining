...
//     setInitialLoading(true); // only for first fetch
...
//   useEffect(() => {
//     if (userId) {
//       fetchTodos(); // ✅ only called once on login
//     } else {
//       setTodos([]);
//       setInitialLoading(false);
//     }
...
//       setTodos((prev) =>
//         prev.map((todo) =>
//           todo.id === editId ? { ...todo, ...todoData } : todo
//         )
//       );
...
//         todoData // 🔹 pass the data object here
//       );
...
//           Please login or signup first to manage todos.
//         </p>
//       )}
...
//               className="border rounded-lg px-4 py-3 text-lg w-full h-32 resize-none"
//             />

//             <div className="flex justify-center">
//               <button
//                 onClick={handleSave}
//                 className="bg-green-600 hover:bg-green-700 text-white px-12 py-4 rounded-lg"
//               >
//                 {editId ? "Update" : "Add"}
//               </button>
//             </div>
...
//                 <li
//                   key={todo.id}
//                   className="grid grid-cols-6 px-4 py-2 border-t items-center hover:bg-green-50"
//                 >
//                   <span>{index + 1}</span>
